...
echo [PERINGATAN] Update tersedia untuk: %THIS_CMD%
...
:: Informasi dan timeout 5 detik sebelum helper dijalankan
echo.
...
echo [INFO] Skrip akan berhenti sekarang supaya file bisa diganti.
exit /b
